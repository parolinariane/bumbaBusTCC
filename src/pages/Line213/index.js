...
export default function Line213() {
  const navigation = useNavigation();
  const mapEl = useRef(null);

  const [origin, setOrigin] = useState({
    latitude: -22.9614743,
    longitude: -47.1915719,
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {destination &&
          <Marker
            ...
            title="R. Luiz Donizetti Rovaris"
            pinColor="#002684"
          />
        }
      </MapView>
      ...
      <View style={styles.search}>
        ...
        <Text style={styles.lineRoutes}>                 Rota Linha 213</Text>
      <Icon name="map-marker" size={25} color="#fff" style={styles.icon} />
        ...
        <TextInput
          style={styles.input}
          placeholder="R. Luiz Donizetti Rovaris"
          editable={false}
        />
