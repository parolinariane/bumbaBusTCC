...
export default function Line210() {
  const navigation = useNavigation();
  const mapEl = useRef(null);

  const [origin, setOrigin] = useState({
    latitude: -22.9421234,
    longitude: -47.1857156,
    ...
    <View style={styles.container}>
      ...
      >
        <Marker
          ...
          pinColor="#002684"
          title="Novo Terminal Campo Grande"
          description="Adélia Vivian Conscetta"
        />
      ...
      <View style={styles.search}>
        ...
        <Text style={styles.lineRoutes}>            Rota Linha 210</Text>
      <Icon name="map-marker" size={25} color="#fff" style={styles.icon} />
        <TextInput
          style={styles.input}
          placeholder="Novo Terminal Campo Grande"
          editable={false}
        />
